...
const EventDagFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_eventdag_free(ptr >>> 0));
/**
...
export class EventDag {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        EventDagFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_eventdag_free(ptr);
    }
    /**
    * @returns {string}
    */
    topoOrderJson() {
        ...
        try {
            ...
            wasm.eventdag_topoOrderJson(retptr, this.__wbg_ptr);
    ...
    */
    size() {
        const ret = wasm.eventdag_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    */
    merge(other) {
        _assertClass(other, EventDag);
        wasm.eventdag_merge(this.__wbg_ptr, other.__wbg_ptr);
    }
    /**
    ...
    */
    addEvent(parents, payload) {
        ...
        try {
            ...
            wasm.eventdag_addEvent(retptr, this.__wbg_ptr, ptr0, len0, addHeapObject(payload));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('aiwa_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
