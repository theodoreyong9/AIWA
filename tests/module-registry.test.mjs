...
import {
  initialModuleRegistryState, registerModule, updateModuleCode, setAuditStatus,
  validateEconomicConfig, selectIdentityScheme,
} from '../public/js/core/modules/module-registry.js';

function baseEntry(overrides = {}) {
  return {
    id: 'mymodule.js', name: 'My Module', icon: '🔮', category: 'Tools',
    description: 'Does a thing.', codeHash: 'hash1', codeUrl: 'https://example.com/mymodule.js',
    author: 'alice', isIssuing: false, timeSensitive: null, economicConfig: null, ...overrides,
  };
}
...
test('updateModuleCode resets auditStatus to unaudited', () => {
...
test('setAuditStatus supports red-listing', () => {
  let { state } = registerModule(initialModuleRegistryState(), baseEntry());
