...
// r = b * max(1,q) with these params (beta=0 nullifies qTotal, C=e-1
// makes ln(1+C)=1 — see reward.test.mjs's header) — chosen so exact
// values stay hand-verifiable against the real formula.
const theta = { alpha: 1, beta: 0, gamma: 1, C: Math.E - 1, minQ: 1 };
